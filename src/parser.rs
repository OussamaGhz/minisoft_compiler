...
lalrpop_mod!(pub grammar); // this will expand to include the parser code generated by LALRPOP
...
impl<'input> Iterator for TokenIterator<'input> {
    type Item = Result<(usize, Token, usize), ParseError<usize, Token, String>>;
